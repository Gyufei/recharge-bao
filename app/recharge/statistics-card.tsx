  ...
  return (
    <div className="stats shadow">
      <div className="stat">
        ...
        <div className="stat-value">{chargeTimes}</div>
      ...
      <div className="stat">
        ...
        <div className="stat-desc">累计充电量: {totalKwh} kWh</div>
      </div>
      ...
      <div className="stat">
        ...
        <div className="stat-value">{totalMileage}</div>
        <div className="stat-desc">{perKmCost} 元/每公里</div>
      </div>
    </div>
  );
}
